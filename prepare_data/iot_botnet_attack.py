...
feature_types.to_csv('data/iot_botnet_attack_' + device + '_feature_types.csv', index=None, header= None)

data.to_csv('data/iot_botnet_attack_' + device + '.csv', index=None, header= None)
